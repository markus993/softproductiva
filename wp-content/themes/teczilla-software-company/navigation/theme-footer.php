		...
		{ 
            ...
            <div class="container">
                <div class="footer-content pt-80 pb-79 md-pb-64 sm-pt-48">
                    <div class="row">
					<?php
			           $teczilla_footer_widgets_column = get_theme_mod( 'teczilla_footer_widgets_column', 'mt-column-4' );
                ...
                <div class="container">
                    <div class="row y-middle">
                        <div class="col-lg-12">
                            ...
                            <p>
                            <?php
                            printf( __( 'Proudly powered by', 'teczilla-software-company' ) );
                            ?>

                            <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'teczilla-software-company' ) ); ?>" class="imprint">
                            	
							<?php
                            printf( __( 'WordPress', 'teczilla-software-company' ) );
                            ?>
                            </a>
