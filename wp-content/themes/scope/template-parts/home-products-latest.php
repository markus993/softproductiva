...
<div class="home-section space tf-products section-products-latest">
	...
	<div class="container">
		<div class="section-heading">
			<h2 class="section-title"><?php echo esc_html(get_theme_mod('scope_home_products_latest_heading')); ?></h2>
	 	    <p class="section-description"><?php echo esc_html(get_theme_mod('scope_home_products_latest_desc')); ?></p>
		</div>
		<div class="section-details home-products products-recents woocommerce">
			<div class="product-carasol products owl-carousel">
			<?php
				$product_count = absint(get_theme_mod('scope_home_products_latest_count', 15));
