...
?>
    ...
    <footer id="colophon" class="site-footer footer" role="contentinfo">
    	<?php if(get_theme_mod('scope_show_footer_widgets', true)): ?>
				...
				<div class="row widgets">
					<?php 
					   ...
					   if ( is_active_sidebar( 'footer-widget-area' ) ) {
							...
							the_widget('WP_Widget_Calendar', 'title='.esc_attr__('Calendar', 'scope'), $footer_widget);
            ...
            <div class="container">
                <div class="row justify-content-center">
	                <div class="col-6 footer-copy text-center">
	                    <p>&copy; <?php echo esc_html(date_i18n(__('Y', 'scope'))).' '; bloginfo( 'name' ); ?> | <?php printf( esc_html__( 'Theme: %1$s', 'scope' ),  '<a href="'.esc_url('https://www.themefarmer.com/scope/').'" rel="designer">Scope</a>' ); ?></p>
	                </div>
                </div>
            </div>
        </div>
