 ...
 */
function scope_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function scope_sanitize_css( $css ) {
 ...
 */
function scope_sanitize_dropdown_pages( $page_id, $setting ) {
 ...
 */
function scope_sanitize_email( $email, $setting ) {
 ...
 */
function scope_sanitize_hex_color( $hex_color, $setting ) {
	// Sanitize $input as a hex value without the hash prefix.
 ...
 */
function scope_sanitize_html( $html ) {
 ...
 */
function scope_sanitize_image( $image, $setting ) {
 ...
 */
function scope_sanitize_nohtml( $nohtml ) {
 ...
 */
function scope_sanitize_number_absint( $number, $setting ) {
 ...
 *                    the setting default.
 */
function scope_sanitize_number_range( $number, $setting ) {
 ...
 */
function scope_sanitize_select( $input, $setting ) {
 ...
 */
function scope_sanitize_url( $url ) {
